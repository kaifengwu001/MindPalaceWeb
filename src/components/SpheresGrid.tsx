...
export const SpheresGrid: React.FC<SpheresGridProps> = ({
  ...
  // const getStatusDisplay = (media: Media) => {
  //   if (!media) return null;

  //   const config = getStatusConfig(media.status || 'ready'); // Provide default status
  //   const { bgColor, textColor, Icon, text, animate } = config;

  //   return (
  //     <div className={`absolute top-2 right-2 flex items-center gap-2 ${bgColor} ${textColor} px-2 py-1 rounded`}>
